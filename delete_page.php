<?php
    //check if admin is logged in,
        //if true connect with database,
        //else return to login page
    require_once("webservice/adminSession.php");

    //get the data for the tour table
...
<nav class="navbar navbar-inverse navbar-static-top">
    <div class="container">
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="webservice/login.php"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
        </ul>
    </div>
</nav>
<section class="container">
    <div class="row">
        ...
        <div class="col-sm-6">
            Voer de naam in van de boeking die u wilt verwijderen
            <form action="webservice/delete.php" method="post">
